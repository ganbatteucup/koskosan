...
<body>
    ...
    <div class="info">
        <a href="{{ route('landing.details', 'coral-pik-seven') }}">
            <h3 class="small-header mb-2">Coral PIK Seven</h3>
        </a>
        <div class="footer">
            <div class="location d-flex flex-row">
                <img src="{{ asset('images/ic_loc.svg') }}" height="20" alt="">
                <p class="small-paragraph mb-0">Exnoparty</p>
                                </div>
                                @php
                                $hasBooked = false;
                                @endphp
                                <div class="price">
                                    <p class="mb-0">
                                    {{ $hasBooked ? 'sold out' : '$28,109'}} <span class="extra-small-paragraph">mo</span>
                                      {{ $hasBooked ? '' : '/mo'}} 
                                    </p>
                                </div>
                                <div class="clear"></div>
